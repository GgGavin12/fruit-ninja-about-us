...
<html lang="en"><head>
    ...
    <div class="main-header">
        ...
        <nav>
        <a href="file:///D:\Folder Les\folder les lagi\Longterm Project\Project.html">Home</a>
       
        <a href="file:///D:\Folder Les\folder les lagi\Longterm Project/About%20us.html">About Us</a>
        </nav>
        </div>
</head>
<body>
    ...
    <section class="center">
      <div class="menu2">
        <div class="menu">
            ...
            <div class="item">
                <div>
                  <div class="textblock"><p data-w-id="f70f1c74-10f8-df29-b703-c95217363cbb" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="paragraph_center calloutparagraph black">Ditemukan pada tahun 2001, Halfbrick telah menjadi yang terdepan dalam industri pengembangan game Australia selama bertahun-tahun.</p></div>
                </div>
